$(function(){
	$('.modal').append('<b></b><a>x <span>Закрыть</span></a>');
	...
	$('button').click(function(){
	    ...
	    {
	       //alert('Верно');
	        tl.to(box0, 1.5, {top:"50px", left:'-1000px', display:'none', ease:Expo.easeInOut})
	   	 	tl.to(box1, 1.5, {right:"0px", ease:Expo.easeInOut}, "-=0.4")
	   	 	tl.to($textp, 1.5, {top:"0px", ease:Expo.easeInOut}, "-=1.2")
	   	 	tl.to($textbt, 1.5, {bottom:"0px", ease:Expo.easeInOut}, "-=1.5");
